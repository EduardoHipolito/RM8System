...
export class AplicationComponent extends baseCrudComponent {
  public url: string = urlBase + "/aplication";
  public currentItem: Aplication;
  public form: FormGroup;

  public _gridSetings: GridSetings;
  public _crudPlugSetings: CrudPlugSetings;
  DdlModulesSetings: DropDownSetings = new DropDownSetings();
  ...
  public initForm() {
    return this._fb.group({
      ...
      IdModule: [null, Validators.required],
      Name: ['', Validators.required],
      AplicationCode: ['', Validators.required],
      Description: ['', Validators.required],
      Index: ['', Validators.required],
      Link: ['', Validators.required],
      ShowMenu: [true, Validators.required]
    });
  }

  InitializeComponent() {
    this.currentItem = new Aplication();
    ...
    var columnName = new GridColumnSetings();
    columnName.name = 'FKModule.Name';
    columnName.title = 'Modulo';
    columnName.sort = new GridSortSetings();
    columnName.filter = new GridFilterSetings();
    columnName.filter.filterString = '';
    columnName.filter.placeholder = 'Modulo';
    columnName.type = 'text';
    ...
    this.DdlModulesSetings.PropertyValue = 'Id';
    this.DdlModulesSetings.PropertyText = 'Name';
    this.DdlModulesSetings.Method = MethodEnum.Get;
    this.DdlModulesSetings.ServiceMethodURL = urlBase + "/module/GetAll";
  ...
  changeDataForm(NewCurrentItem) {
    ...
    this.currentItem.AplicationCode = this.form.value.AplicationCode;
    this.currentItem.Index = this.form.value.Index;
    this.currentItem.Link = this.form.value.Link;
    this.currentItem.ShowMenu = this.form.value.ShowMenu;
    this.currentItem.IdModule = this.form.value.IdModule;
