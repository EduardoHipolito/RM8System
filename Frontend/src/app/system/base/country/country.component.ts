...
export class CountryComponent extends baseCrudComponent  {
  public url: string = urlBase + "/country";
  ...
  changeDataForm(NewCurrentItem) {
    ...
    this.currentItem.PhoneCode = this.form.value.PhoneCode;
