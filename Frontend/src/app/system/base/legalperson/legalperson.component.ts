...
export class LegalPersonComponent extends baseCrudComponent {
  ...
  InitializeComponent() {
    ...
    this.currentItem = new LegalPerson();
    ...
    this._crudPlugSetings.Url = urlBase + "/LegalPerson";
