...
import { Supplier } from '../../_domains/Supplier';
...
export class SupplierComponent extends baseCrudComponent  {
  public url: string = urlStock + "/supplier";
  public currentItem: Supplier;
  public form: FormGroup;

  public _gridSetings: GridSetings;
  public _crudPlugSetings: CrudPlugSetings;
  DdlLegalPeopleSetings: DropDownSetings = new DropDownSetings();
  DdlSupplierTypeSetings: DropDownSetings = new DropDownSetings();
  ...
  public initForm() {
    return this._fb.group({
      ...
      SupplierType: [SupplierType.Produtos, Validators.required],
      IdLegalPerson: [null, Validators.required],
      MoreInformation: [''],
    });
  }

  InitializeComponent() {
    this.currentItem = new Supplier();
    ...
    this.DdlLegalPeopleSetings.PropertyValue = 'Id';
    this.DdlLegalPeopleSetings.PropertyText = 'Name';
    this.DdlLegalPeopleSetings.Method = MethodEnum.Get;
    this.DdlLegalPeopleSetings.ServiceMethodURL = urlBase + "/legalperson/GetAll";

    
    let typeList = Methods.EnumToArray(SupplierType);
    this.DdlSupplierTypeSetings.DataSource = typeList;
  ...
  changeDataForm(NewCurrentItem) {
    ...
    this.currentItem.IdLegalPerson = this.form.value.IdLegalPerson;
    ...
    this.currentItem.SupplierType = this.form.value.SupplierType;
  }

  rowClick(val: Supplier) {
