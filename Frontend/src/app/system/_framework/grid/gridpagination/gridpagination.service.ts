...
export class GridPaginationService {
     ...
     */
    private updateInstance(instance: GridPaginationConfig): boolean {
        let changed = false;
     ...
     */
    public getInstance(id: string = this.DEFAULT_ID): GridPaginationConfig {
        if (this.instances[id]) {
            return this.clone(this.instances[id]);
        }
        return {} as GridPaginationConfig;
    }
