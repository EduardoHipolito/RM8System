...
namespace NFE.Business.Operacao
{
    public class Inutilizacao : BaseOperacao
    {
        ...
        public RetornoSimples NfeInutilizacaoNF2(NFE.Business.Consulta.Inutilizacao inutilizacao)
        {
        ...
        private XmlNode Assinar(StringBuilder xmlStringBuilder, String id)
        {
            ...
            try
            {
                //bllXml.ValidaSchema(arquivoTemporario, Util.ContentFolderSchemaValidacao + "\\" + NFeContexto.Versao.PastaXml + "\\" + ArquivoSchema);
            }
            catch (Exception e)
            {
