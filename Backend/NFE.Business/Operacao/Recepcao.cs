...
using System.Xml;
using NFE.Business.Assinatura;
using NFE.Business.Operacao;
using NFE.Domain.Contexto;
using NFE.Domain.NotaFiscal;
...
namespace NFeEletronica.Operacao
{
    public class Recepcao : BaseOperacao
    {
        ...
        public void AdicionarNota(Nota nota)
        {
            ...
            try
            {
                //bllXml.ValidaSchema(nota.CaminhoFisico, Util.ContentFolderSchemaValidacao + "\\" + NFeContexto.Versao.PastaXml + "\\" + arquivoSchema);
            }
            catch (Exception e)
            {
        ...
        public NFE.Business.Retorno.Recepcao Enviar(long numeroLote, String cUF)
        {
            ...
            return new NFE.Business.Retorno.Recepcao(recibo, "", motivo);
        }
    }
}