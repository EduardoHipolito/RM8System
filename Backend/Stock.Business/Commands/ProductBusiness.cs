...
{
    public class ProductBusiness : BusinessBase<Product, ProductDataAccess>, IProductBusiness
    {
        ...
        {
            return FactoryComponent.GetInstance<IUserAplicationCompanyBusiness>().ValidatePermition(UserId, IdCompany, AplicationsCodes.ModuleCode, AplicationsCodes.Product);
        }
    }
}