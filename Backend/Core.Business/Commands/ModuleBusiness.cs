...
{
    public class ModuleBusiness : BusinessBase<Module, ModuleDataAccess>, IModuleBusiness
    {
        ...
        {
            return FactoryComponent.GetInstance<IUserAplicationCompanyBusiness>().ValidatePermition(UserId, IdCompany, AplicationsCodes.ModuleCode, AplicationsCodes.Module);
        }
    }
}