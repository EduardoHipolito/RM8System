...
{
    public class CnaeBusiness : BusinessBase<Cnae, CnaeDataAccess>, ICnaeBusiness
    {
        ...
        {
            return FactoryComponent.GetInstance<IUserAplicationCompanyBusiness>().ValidatePermition(UserId, IdCompany, AplicationsCodes.ModuleCode, AplicationsCodes.Cnae);
        }
    }
}