...
{
    public class AddressBusiness : BusinessBase<Address, AddressDataAccess>, IAddressBusiness
    {
        ...
        {
            return FactoryComponent.GetInstance<IUserAplicationCompanyBusiness>().ValidatePermition(UserId, IdCompany, AplicationsCodes.ModuleCode, AplicationsCodes.Address);
        }
    }
}